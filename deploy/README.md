...
| `k3s/20-networkpolicy.yaml` | Default deny in both directions; the game port from anywhere, the private bridge port from the node, the operator ports from monitoring only, no egress. |
