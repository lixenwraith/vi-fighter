...
func (w *World) wipeAll() {
	w.Components.Glyph.ClearAllComponent()
	w.Components.Sigil.ClearAllComponent()
	w.Components.Nugget.ClearAllComponent()
	w.Components.Cursor.ClearAllComponent()
	w.Components.Protection.ClearAllComponent()
	w.Components.Energy.ClearAllComponent()
	w.Components.Heat.ClearAllComponent()
	w.Components.Shield.ClearAllComponent()
	w.Components.Boost.ClearAllComponent()
	w.Components.Ping.ClearAllComponent()
	w.Components.Drain.ClearAllComponent()
	w.Components.Decay.ClearAllComponent()
	...
	w.Components.Materialize.ClearAllComponent()
	w.Components.Header.ClearAllComponent()
	w.Components.Member.ClearAllComponent()
	w.Components.Flash.ClearAllComponent()
	w.Components.Splash.ClearAllComponent()
	w.Components.Death.ClearAllComponent()
	w.Components.Timer.ClearAllComponent()
