...
func ApplyHoming(k *Kinetic, targetX, targetY float64, profile *HomingProfile, dt float64) bool {
	return applyHomingInternal(k, targetX, targetY, profile, 1.0, dt, true)
}
