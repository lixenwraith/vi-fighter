...
func GravitationalAccel3D(posA, posB vmath.Vec3, massB, G int64) vmath.Vec3 {
	...
	return vmath.Vec3{
		X: vmath.Mul(vmath.Div(delta.X, dist), accelMag),
		Y: vmath.Mul(vmath.Div(delta.Y, dist), accelMag),
		Z: vmath.Mul(vmath.Div(delta.Z, dist), accelMag),
	}
}
...
func GravitationalAccelWithRepulsion3D(posA, posB vmath.Vec3, massB, G, repulsionRadius, repulsionStrength int64) vmath.Vec3 {
	...
	return vmath.Vec3{
		X: vmath.Mul(dirX, accelMag),
		Y: vmath.Mul(dirY, accelMag),
		Z: vmath.Mul(dirZ, accelMag),
	}
}
