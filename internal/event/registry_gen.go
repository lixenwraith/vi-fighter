...
func InitRegistry() {
	...
	RegisterType("EventParticipantReachable", EventParticipantReachable, &ParticipantReachablePayload{})
	...
	RegisterType("EventDrainPause", EventDrainPause, &CursorScopePayload{})
	RegisterType("EventDrainResume", EventDrainResume, &CursorScopePayload{})
...
var eventClasses = [EventTypeCount]EventClass{
	...
	EventParticipantReachable:            ClassBus,
