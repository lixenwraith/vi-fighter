...
var systemDomains = map[string]engine.SystemDomain{
	"cursor":         engine.SystemShared,
	"ping":           engine.SystemPlayer,
	"transient":      engine.SystemPlayer,
	"camera":         engine.SystemPlayer,
	"energy":         engine.SystemPlayer,
	"shield":         engine.SystemPlayer,
	"heat":           engine.SystemPlayer,
	"boost":          engine.SystemPlayer,
	"weapon":         engine.SystemPlayer,
	"typing":         engine.SystemPlayer,
	"composite":      engine.SystemShared,
	"wall":           engine.SystemShared,
	"tower":          engine.SystemShared,
	"gateway":        engine.SystemShared,
	"loot":           engine.SystemPlayer,
	"glyph":          engine.SystemPlayer,
	"nugget":         engine.SystemShared,
	"decay":          engine.SystemPlayer,
	"blossom":        engine.SystemPlayer,
	"gold":           engine.SystemShared,
	"materialize":    engine.SystemDual,
	"cleaner":        engine.SystemDual,
	"fuse":           engine.SystemPlayer,
	"spirit":         engine.SystemDual,
	"lightning":      engine.SystemPlayer,
	"missile":        engine.SystemPlayer,
	"navigation":     engine.SystemShared,
	"soft_collision": engine.SystemDual,
	"combat":         engine.SystemDual,
	"drain":          engine.SystemPlayer,
	"quasar":         engine.SystemShared,
	"swarm":          engine.SystemShared,
	"storm":          engine.SystemShared,
	"pylon":          engine.SystemShared,
	"snake":          engine.SystemShared,
	"eye":            engine.SystemShared,
	"bullet":         engine.SystemPlayer,
	"dust":           engine.SystemPlayer,
	"flash":          engine.SystemPlayer,
	"fadeout":        engine.SystemPlayer,
	"marker":         engine.SystemShared,
	"explosion":      engine.SystemShared,
	"motion_marker":  engine.SystemPlayer,
	"splash":         engine.SystemPlayer,
	"environment":    engine.SystemShared,
	"death":          engine.SystemDual,
	"timer":          engine.SystemDual,
	"adaptation":     engine.SystemShared,
	"genetic":        engine.SystemShared,
	"audio":          engine.SystemPlayer,
	"music":          engine.SystemPlayer,
	"meta":           engine.SystemShared,
}
