...
func main() {
	...
	generateFile("../system/domain_gen.go", systemDomainTemplate, defs)
...
var systemDomainTemplate = template.Must(template.New("system-domain").Parse(`// Code generated by gen-manifest; DO NOT EDIT.
