...
// Requires nothing: a sweep is requested, and its effects are optional.
func (s *CleanerSystem) Requires() engine.SystemDependencies {
	return engine.Optional("combat", "decay")
}
